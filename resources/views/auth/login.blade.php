<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="'Email atau Nama Pengguna'" />
            <x-text-input id="email" class="block w-full mt-1" type="text" name="email" :value="old('email')" required autofocus autocomplete="email" />
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="text-sm text-gray-600 ms-2 dark:text-gray-400">Ingatkan saya</span>
            </label>
        </div>
